...
- <img src="https://github.com/johnanleitner1-Coder.png" height="14"/> [Last Minute Deals HQ](https://github.com/johnanleitner1-Coder/lastminutedeals-api) - Real-time last-minute tour and activity booking across 17 suppliers in 15 countries. Search availability, create Stripe checkouts, track bookings via MCP tools.
